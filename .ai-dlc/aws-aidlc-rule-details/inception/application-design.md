...
- High-Level Design recommended (provides macro architecture and component map to refine)
...
- Per `common/architecture-decision-records.md`: create an ADR for any component boundary or design decision where meaningful alternatives were considered and presented to the user. Reference the ADR number(s) from `application-design.md`
