...
| Backend Services | Python + FastAPI | Cùng ngôn ngữ với Manim (đơn giản hóa việc gọi Manim trực tiếp trong Rendering Service), FastAPI nhẹ, hỗ trợ async tốt, phù hợp expose REST API và luồng sự kiện |
